...
sources.forEach(function(source, i) {
	...
	let articleList = articles[id].map((art) => {
        ...
        imageUrl = (art.urlToImage != null)? art.urlToImage: "http://placehold.it/250x125";
		...
		return `<li class="${cname}">
			...
			<img src="${imageUrl}" alt="${art.title}" onerror="hideme(this)">
		</li>`;
	});
...
var Slider = {
	init: function(selector) {
		...
		this.slider = document.querySelector('.slider__slides');
